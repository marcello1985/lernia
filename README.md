...
![lernia logo](fig/lernia_logo.png "lernia logo")
...
![replace_nan](f_mot/replace_nan.png "data homogenity")
...
![ref_smoothing](fig/prep_poly_smooth.png "smoothing of reference data")
...
![ref_volatility](fig/chisq_dis.png "chi square of the reference time series")
_Distribution of p-value from $\chi^2$ for the reference data_

We than replace the outliers:

![replace_volatility](fig/replace_volatile.png "we replace volatile days with an average day")
...
![stat prop](fig/stat_prop.png "statistical properties")
...
![importance statistical properties](fig/importance_statProp.png "importance of statistic properties")
...
![stat prop traininig](fig/statProp_training.png "training on statistical properties")
...
![feature importance](fig/feature_importance.png "feature importance")
...
![confusion matrix](fig/confusion_feature.png "confusion matrix on input feature")
...
![weather feature](fig/weather_feature.png "weather features")
_correlation between weather features_

Other weather related parameters have an influence on the mismatch.
![weather_correlation](fig/weather_correlation.png "weather influences the difference")
...
![model_score](fig/model_score.png "performance of models")
...
![time series](fig/time_series.png "example of a time series")
_time series of a location_
and the daily average where we can understand the typical daily activity.

![daily average](fig/time_series_day.png "daily average")
...
![shape clustering](fig/shape_clustering.png "We cluster curves by shapes")
...
![correlation matrix](fig/correlation_matrix.png "correlation matrix between features")
...
![selected features](fig/selected_features.png "final selection of features")
...
![scoring explanation](fig/scoring.png "scoring graphical visualization")
...
![week_image](fig/week_img.png "image representation of many weeks")
...
![tensorboard](fig/tensorboard.png "sketch of the learning phases")
...
![raw_vs_predicted](fig/ref_pred.png "results of predictor")
...
![autoencoder_performance](fig/autoencoder_performance.png "autoencoder performance")
...
![result no order](fig/result_no_order.png "resulting activities per location")
...
![result order](fig/result_order.png "activities sorted by p-value")
_activities sorted by p-value_

To summarize we generate the results applying the following scheme:
![filter structure](fig/filter_structure.png "application of the predictor and regressor")
...
![flow chart](fig/test_flow.png "flow chart of the project")
