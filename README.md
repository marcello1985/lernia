...
![lernia logo](f_lernia/lernia_logo.png "lernia logo")
...
* etl
* data cleaning 
* [feature selection](lernia_feature.md)
...
![replace_nan](f_lernia/replace_nan.png "data homogenity")
...
![ref_smoothing](f_lernia/prep_poly_smooth.png "smoothing of reference data")
...
![ref_volatility](f_lernia/chisq_dis.png "chi square of the reference time series")
_Distribution of p-value from $\chi^2$ for the reference data_

We than replace the outliers:

![replace_volatility](f_lernia/replace_volatile.png "we replace volatile days with an average day")
...
![stat prop](f_lernia/stat_prop.png "statistical properties")
...
![importance statistical properties](f_lernia/importance_statProp.png "importance of statistic properties")
...
![stat prop traininig](f_lernia/statProp_training.png "training on statistical properties")
...
![feature importance](f_lernia/feature_importance.png "feature importance")
...
![confusion matrix](f_lernia/confusion_feature.png "confusion matrix on input feature")
...
![weather feature](f_lernia/weather_feature.png "weather features")
_correlation between weather features_

Other weather related parameters have an influence on the mismatch.
![weather_correlation](f_lernia/weather_correlation.png "weather influences the difference")
...
![model_score](f_lernia/model_score.png "performance of models")
...
![time series](f_lernia/time_series.png "example of a time series")
_time series of a location_
and the daily average where we can understand the typical daily activity.

![daily average](f_lernia/time_series_day.png "daily average")
...
![shape clustering](f_lernia/shape_clustering.png "We cluster curves by shapes")
...
![correlation matrix](f_lernia/correlation_matrix.png "correlation matrix between features")
...
![selected features](f_lernia/selected_features.png "final selection of features")
...
![scoring explanation](f_lernia/scoring.png "scoring graphical visualization")
...
![week_image](f_lernia/week_img.png "image representation of many weeks")
...
![tensorboard](f_lernia/tensorboard.png "sketch of the learning phases")
...
![raw_vs_predicted](f_lernia/ref_pred.png "results of predictor")
...
![autoencoder_performance](f_lernia/autoencoder_performance.png "autoencoder performance")
...
![result no order](f_lernia/result_no_order.png "resulting activities per location")
...
![result order](f_lernia/result_order.png "activities sorted by p-value")
_activities sorted by p-value_

To summarize we generate the results applying the following scheme:
![filter structure](f_lernia/filter_structure.png "application of the predictor and regressor")
...
![flow chart](f_lernia/test_flow.png "flow chart of the project")
